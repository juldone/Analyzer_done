...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = 'inline-flex items-center justify-center rounded-md font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-dark-800';
  
  const variantClasses = {
    primary: 'bg-primary-500 hover:bg-primary-600 text-white focus:ring-primary-500',
    secondary: 'bg-accent-500 hover:bg-accent-600 text-white focus:ring-accent-500',
    outline: 'bg-transparent border border-gray-600 hover:bg-dark-700 text-white focus:ring-gray-500',
